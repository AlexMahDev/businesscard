                          ...
                          children: [
                            GestureDetector(
                              onTap: () {
                                ...
                                final fullNameDropdownBloc = BlocProvider.of<FullNameDropdownBloc>(context);
...
class ChooseColorWidget extends StatelessWidget {
  ...
  const ChooseColorWidget({Key? key, required this.color})
      : super(key: key);
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: selectCardColor.state == color ? Colors.grey : Colors
                    .transparent, width: 2),
          ),
          child: Center(
            child: Container(
